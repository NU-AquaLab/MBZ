...
namespace pcpp
{
	...
	public:
		 ...
		 * @param[in] m_val Set or unset the bit
		 */
		 ...
		 * @param[in] m_val The exp value to set. m_val must be a valid number meaning between 0 and 7 (inclusive)
		 * @return True if exp value was set successfully or false if m_val has invalid value
		 */
